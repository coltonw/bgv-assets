...
(function ($) {
  ...
  $.fn.sortable = function (options) {
    ...
    return this.each(function () {
      if (method === 'reload' || options.method === 'reload') {
      ...
      items.attr('draggable', 'true').on('dragstart.h5s',function (e) {
        ...
        startParent = $(this).parent();
          ...
          return false;
        }).end().add([this, placeholders]).on('dragover.h5s dragenter.h5s drop.h5s', function (e) {
          ...
          if (items.is(this)) {
            ...
            var x = e.originalEvent.pageX,
                ...
                ph = $(ph),
                offset = ph.offset(),
                height = ph.outerHeight(),
                width = ph.outerWidth();

            return x < offset.left || y < offset.top || x > offset.left + width || y > offset.top + height;
          })){
            placeholders.detach();
